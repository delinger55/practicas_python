...
Objetivo
Crea un sistema simple de gestión de libros en una biblioteca. Este sistema debe incluir diferentes tipos 
de materiales (libros, revistas, y periódicos), cada uno con sus características y comportamiento específicos.
utilizando conceptos de programación orientada a objetos como clases, herencia, atributos, propiedades y 
métodos.
...
   Utiliza un método setter para asegurar que el año de publicación no sea un valor futuro. Si se intenta 
establecer un año en el futuro, se lanza una excepción ValueError.
...
o   Método informacion:
   Sobreescribe el método de la clase base para incluir también el número de páginas en la descripción del 
libro.
...
o   Método informacion:
   Sobreescribe el método de la clase base para incluir también el número de edición en la descripción de 
la revista.
...
o   Método informacion:
   Sobreescribe el método de la clase base para incluir también la fecha de publicación en la descripción 
del periódico.
...
3.  Salida Esperada:
o   La salida muestra la información completa de cada material, incluyendo los atributos adicionales 
específicos de cada tipo de material.
Este desafío te ayudará a comprender cómo utilizar la herencia y las propiedades en Python, además de cómo 
extender el comportamiento de una clase base en clases derivadas.
...
class MaterialBiblioteca:
    def __init__(self, titulo, autor, annio_publicacion):
        self.titulo = titulo
        self.autor = autor
        self._annio_publicacion = annio_publicacion
    
    @property
    def annio_publicacion(self):
        return self._annio_publicacion
    ...
    def informacion(self):
        print(f"Libro: {self.titulo}, autor: {self.autor}, año publicacion: {self._annio_publicacion}")