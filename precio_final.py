...
El descuento no puede ser negativo ni mayor que 100; en esos casos, la función debe devolver
el mensaje "Descuento inválido".
Escribe un código que solicite al usuario que ingrese el precio inicial y el descuento, y 
luego muestre el precio final utilizando la función calcular_precio_final
"""
